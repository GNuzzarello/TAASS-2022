...
public class TinyDB {
    ...
    public ArrayList<TicketOrder> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<TicketOrder> plist =  new ArrayList<TicketOrder>();

        for(String jObjString : objStrings){
            TicketOrder item  = gson.fromJson(jObjString,  TicketOrder.class);
            plist.add(item);
        }
        return plist;
    }
    ...
    public void putListObject(String key, ArrayList<TicketOrder> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(TicketOrder player: playerList){
