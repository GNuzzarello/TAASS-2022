        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (holder.categoryName.getText().toString()){
                    case "All":
                        String url = "http://192.168.1.132:8080/api/tickets";
                        new FetchDataTask(mainActivity).execute(url,"GET");
                        return;
                    case"Sport":
                        String url1 = "http://192.168.1.132:8080/api/tickets/Sport";
                        new FetchDataTask(mainActivity).execute(url1,"GET");
                        return;
                    case"Cinema":
                        String url2 = "http://192.168.1.132:8080/api/tickets/Cinema";
                        new FetchDataTask(mainActivity).execute(url2,"GET");
                        return;
                    case"Concert":
                        String url3 = "http://192.168.1.132:8080/api/tickets/Concert";
