...
public class MainActivity extends AppCompatActivity {
    ...
    private String url = "http://192.168.1.132:8080/api/tickets";
    ArrayList<TicketOrder> ticketList = new ArrayList<TicketOrder>();
    ArrayList<TicketOrder> nuovalista = new ArrayList<>();
    ...
    protected void onStart() {
        ...
        rangeSlider.addOnChangeListener(new RangeSlider.OnChangeListener() {
            ...
            public void onValueChange(@NonNull RangeSlider slider, float value, boolean fromUser) {
                ...
                new FetchDataTask(MainActivity.this).execute("http://192.168.1.132:8080/api/tickets/"+ min + "/-/" + max,"GET");
    ...
    private void filter(String newText) {
        nuovalista.clear();
        for (TicketOrder po : ticketList) {
            if(po.getTicket().getName().toLowerCase().contains(newText.toLowerCase())){
                nuovalista.add(po);
    ...
    private void recyclerViewPopular(ArrayList<TicketOrder> tickets) {
        ...
        adapter2 = new PopularAdapter(tickets);
    ...
    private void recyclerViewCategory() {
        ...
        categoryList.add(new CategoryDomain("All", "cat_all"));
        categoryList.add(new CategoryDomain("Sport", "cat_22"));
        categoryList.add(new CategoryDomain("Cinema", "cat_33"));
        categoryList.add(new CategoryDomain("Concert", "cat_44"));
    ...
    public void parseJSON(String data){
        ...
        recyclerViewPopular(ticketList);
        ...
        try{
            ...
            for(int i=0; i < jsonMainNode.length(); i++) {
                ...
                String place = jsonChildNode.getString("place");
                String date = jsonChildNode.getString("date");
                Ticket p = new Ticket(id, name, price, Ticket.stringToCategory(category), picture_url,description, place, date);
                TicketOrder po = new TicketOrder(p,0);
                this.ticketList.add(po);
            }
